  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const { error } = await supabase.from("support_ticket_messages").insert({
        ...
        sender_name: customer?.full_name || user.user_metadata?.full_name || user.email || "Customer",
        message: reply.trim(),
        ...(attachment || {}),
      });
    ...
    <CustomerProfileGate>
      <div className="space-y-6">
        <PageHeader
          ...
          backLink="/customer/support-tickets"
        />
          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,1.35fr)_340px]">
            <div className="space-y-6">
              ...
              <SupportTicketComposer
                ...
                placeholder="Add more details, ask a follow-up question, or attach a file."
              />
            </div>
...
export default CustomerSupportTicketDetail;
