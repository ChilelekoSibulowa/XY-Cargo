-- Allow customers and agents to submit consolidation requests and keep
-- shipment status sync aligned with portal ownership rules.
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'Agents can update shipments'
  ) THEN
    CREATE POLICY "Agents can update shipments"
      ON public.shipments
      FOR UPDATE
      TO authenticated
      USING (
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'Customers can create consolidations'
  ) THEN
    CREATE POLICY "Customers can create consolidations"
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'consolidations'
      AND policyname = 'Agents can view consolidations for their customers'
  ) THEN
    CREATE POLICY "Agents can view consolidations for their customers"
      ON public.consolidations
      FOR SELECT
      TO authenticated
      USING (
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'consolidations'
      AND policyname = 'Agents can create consolidations for their customers'
  ) THEN
    CREATE POLICY "Agents can create consolidations for their customers"
      ON public.consolidations
      FOR INSERT
      TO authenticated
      WITH CHECK (
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'consolidations'
      AND policyname = 'Agents can update consolidations for their customers'
  ) THEN
    CREATE POLICY "Agents can update consolidations for their customers"
      ON public.consolidations
      FOR UPDATE
      TO authenticated
      USING (
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'consolidation_shipments'
      AND policyname = 'Agents can view consolidation shipments for their customers'
  ) THEN
    CREATE POLICY "Agents can view consolidation shipments for their customers"
      ON public.consolidation_shipments
      FOR SELECT
      TO authenticated
      USING (
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'consolidation_shipments'
      AND policyname = 'Agents can create consolidation shipments for their customers'
  ) THEN
    CREATE POLICY "Agents can create consolidation shipments for their customers"
      ON public.consolidation_shipments
      FOR INSERT
      TO authenticated
      WITH CHECK (
...
GRANT SELECT, INSERT, UPDATE ON TABLE public.consolidations TO authenticated;
GRANT SELECT, INSERT ON TABLE public.consolidation_shipments TO authenticated;
